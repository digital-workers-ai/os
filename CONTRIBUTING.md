...
The example env is empty and that runs: every knob has a default. The compose project is `os_studio`: postgres on :6442, the mock providers on :9192, the backend on :9092, the console on :4092. The Configuration section of `README.md` lists every variable.
