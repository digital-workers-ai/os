...
HEYGEN_CREDENTIAL_ENV = "HEYGEN_API_KEY"
DEEPGRAM_CREDENTIAL_ENV = "DEEPGRAM_API_KEY"
PAINT_CREDENTIAL_ENV = "OPENAI_API_KEY"
LLM_FLAGS = ("ENRICHMENT_ENABLED", "COACHING_ENABLED", "CONVERSATION_ENABLED")
RENDER_FLAGS = ("RENDER_ENABLED",)
CREDENTIALS = {
    ANTHROPIC_CREDENTIAL_ENV: LLM_FLAGS,
    EMBEDDINGS_CREDENTIAL_ENV: ("EMBEDDINGS_ENABLED",),
    RERANK_CREDENTIAL_ENV: ("RERANK_ENABLED",),
    HEYGEN_CREDENTIAL_ENV: RENDER_FLAGS,
    DEEPGRAM_CREDENTIAL_ENV: RENDER_FLAGS,
}
