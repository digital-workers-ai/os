...
const CLAIMS_HINT = 'Every sentence in the piece that asserts something, with the source that backs it; a tick means the source was named and found.'
...
export function Lineage({ asset, version }: { asset: Asset; version: number }) {
  ...
  return (
    <section className="flex flex-col gap-2" data-testid="asset-lineage" data-version={version}>
      ...
      <h3 className="mt-2 text-xs font-medium uppercase tracking-wide text-muted">
        Claims
